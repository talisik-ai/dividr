        ...
        >
          <motion.div
            style={{
              ...
              height: useTransform(scale, [1, 1.2], [thickness, thickness * 2]),
              marginTop: useTransform(scale, [1, 1.2], [0, -thickness / 2]),
              marginBottom: useTransform(scale, [1, 1.2], [0, -thickness / 2]),
            }}
