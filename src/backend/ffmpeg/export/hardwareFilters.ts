 ...
 */
export function supportsCUDAFilters(
  hwAccel: HardwareAcceleration | null,
): boolean {
...
export function buildAspectRatioScaleFilter(
  ...
  return buildScaleFilter(inputRef, outputRef, width, height, hwAccel, {
 ...
 */
export function buildGPUUpload(inputRef: string, outputRef: string): string {
 ...
 */
export function buildGPUDownload(inputRef: string, outputRef: string): string {
 ...
 */
export function getScalingAlgorithmName(
  hwAccel: HardwareAcceleration | null,
): string {
  if (supportsCUDAFilters(hwAccel)) {
    return 'CUDA (GPU)';
 ...
 */
export function getHardwareAccelerationStatus(
  hwAccel: HardwareAcceleration | null,
): string {
